...
export const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 z-50 flex flex-col h-screen w-20 group border-r bg-card/60 backdrop-blur-sm p-4 shadow-md transition-all duration-300 ease-in-out hover:w-64">
