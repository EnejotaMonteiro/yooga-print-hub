...
const WikiPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:pl-8 flex flex-col h-full">
      <h1 className="text-3xl font-bold text-foreground mb-8 flex items-center gap-3">
        <Book className="h-7 w-7 text-primary" />
        Wiki de Suporte
      </h1>

      <Card className="flex-1 max-w-full mx-auto bg-card/80 backdrop-blur-sm border-border shadow-elegant flex flex-col overflow-hidden">
        <CardHeader>
          <CardTitle>Base de Conhecimento Yooga</CardTitle>
          <CardDescription>
